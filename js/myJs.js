const textConfig = {
  text1: "He luu Hà nha!",
  text2: "Anh có điều này muốn hỏi em nhớ phải trả lời thật lòng nha :3333",
  text3: "Em đã bắt đầu yêu anh có phải không nào ._.",
  text4: "Nếu em ko trả lời mà thoát ra tức là muốn làm vợ anh rùi đó nha :v",
  text5: "Anh mơ à???",
  text6: "Em đã bắt đầu thấy thích anh r đó <3",
  text7: "Lí do nào mà em thích anh thế :vvvv",
    ...
    Swal.fire({
      ...
      if (result.value) {
        Swal.fire({
          ...
          onClose: () => {
            window.location = "https://www.facebook.com/namnom.nguyen";
          },
        });
      }
    });
